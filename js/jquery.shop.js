(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Monsoon-https://monsoonmalabar.com/jasmineoilsandspices-"; // Prefix string to be prepended to the cart's name in the session storage
		...
		sendEmail: function() {
			if( this.$checkoutCart.length && this.$userDetails.length ) {
				...
				if( items.length == 0 ) {
					...
					var uemail = 'Mansur1995.007@gmail.com';
